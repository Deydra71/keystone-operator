...
type ApplicationCredentialSpec struct {
	...
	// Roles - optional list of roles assigned to the AC
	Roles []string `json:"roles,omitempty"`

	// ExpirationDays - optional, how many days until we expire
	ExpirationDays int `json:"expirationDays,omitempty"`

	// GracePeriodDays - optional, how soon before expiry we rotate
